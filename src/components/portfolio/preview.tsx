    ...
    <section id="portfolio" ref={ref} class="bg-bg-soft">
      <div class="max-w-[1100px] mx-auto py-28 px-6">
        <div class="flex items-end justify-between gap-5 mb-3.5 reveal">
          ...
          <Link href="/portfolio" class="shrink-0 inline-flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-semibold bg-sa/10 border border-sa/25 text-sa no-underline transition-all hover:bg-sa hover:text-bg hover:border-sa hover:-translate-y-0.5">
