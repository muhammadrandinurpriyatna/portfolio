            ...
            >
              <div class="relative h-[180px] overflow-hidden shrink-0">
                ...
                <div class="absolute top-3.5 right-3.5 flex gap-2 z-[1] opacity-0 -translate-y-1.5 transition-all group-hover:opacity-100 group-hover:translate-y-0">
                  {p.github && (
                    <a href={p.github} class="w-[34px] h-[34px] flex items-center justify-center bg-black/50 backdrop-blur-lg border border-white/20 rounded-lg text-white no-underline transition-all hover:bg-sa hover:border-sa hover:scale-110 hover:rotate-[20deg]" title="GitHub" target="_blank" rel="noreferrer">
                  ...
                  {p.live && (
                    <a href={p.live} class="w-[34px] h-[34px] flex items-center justify-center bg-black/50 backdrop-blur-lg border border-white/20 rounded-lg text-white no-underline transition-all hover:bg-sa hover:border-sa hover:scale-110 hover:rotate-[20deg]" title="Live Demo" target="_blank" rel="noreferrer">
