  ...
  <>
    <div class="pt-[100px] pb-10 bg-bg border-b border-bdr">
      <div class="max-w-[1100px] mx-auto px-6">
        ...
        <span class="block font-mono text-[11px] tracking-[3px] uppercase text-sa mb-2.5">Latar Belakang</span>
        <h1 class="text-[clamp(28px,4vw,44px)] font-extrabold text-ink leading-[1.1]">Pendidikan & <span class="text-gradient">Sertifikasi</span></h1>
      </div>
    </div>
    <Education />
  </>
